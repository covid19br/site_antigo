...
número de novos casos está aumentando**.  Marcamos este limite com uma
linha vermelha. Números próximos de um indicam que o número de casos
novos está constante. Números muito abaixo de um indicam que o número
de novos casos está caindo. Marcamos o limite de $R_e=1$ com uma linha
vermelha.
