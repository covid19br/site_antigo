...
<div class="item">
 ...
 ![](fig/leitos.png)
  ...
  Sem nenhuma medida de controle de contágio, os leitos hospitalares da cidade de São Paulo já teriam sido completamente ocupados por pacientes de COVID-19 no dia 06 de abril.
...
<!--<div class="item">
 ...
 ![](fig/.png)
  ...
  Estimamos o número de casos graves usando os dados de notificação de hospitalizações por SRAG (Síndrome Respiratória Aguda Grave) da base SIVEP-Gripe, para o município de São Paulo. Nossa técnica estatística permite corrigir os atrasos de notificação, acesse <a href="informacoes.html">aqui</a> para +Info. 
