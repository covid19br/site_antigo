...
dias, e os intervalos de confiança dos valores previstos (gáfico ao lado).
...
a primeira estimativa é para o período de `r format(min(time(brasil.d0)), "%d de %B")` a 
