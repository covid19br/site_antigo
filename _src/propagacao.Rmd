...
Os resultados recentes de aumento no tempo de duplicação podem ser devido tanto à dinâmica das notificações quanto à dinâmica da epidemia. Não há como separá-las sem informações mais detalhadas sobre cobertura de testagem ou número de testes aguardando análise por parte dos órgãos públicos.  
