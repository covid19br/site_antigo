...
const locale =
    [ 
        ...
        { prep: "em", uf: "AM", mun:"Manaus",           verbose: "Manaus",           has_modelogro: false, has_td: true  },
        { prep: "em", uf: "AM", mun:"Tabatinga",        verbose: "Tabatinga",        has_modelogro: false, has_td: true  },
        ...
        { prep: "em", uf: "RS", mun:"Porto_Alegre",        verbose: "Porto Alegre",        has_modelogro: false, has_td: true  },
        { prep: "em", uf: "SP", mun:"Sao_Bernardo_do_Campo",        verbose: "São Bernardo do Campo",        has_modelogro: false, has_td: true  },
        { prep: "em", uf: "SP", mun:"Guarulhos",        verbose: "Guarulhos",        has_modelogro: false, has_td: true  },
        ...
        { prep: "em", uf: "CE", mun:"Fortaleza",        verbose: "Fortaleza",        has_modelogro: false, has_td: true  },
        { prep: "em", uf: "RJ", mun:"Duque_de_Caxias",        verbose: "Duque de Caxias",        has_modelogro: false, has_td: true  },
        ...
        { prep: "em", uf: "ES", mun:"Vitoria",        verbose: "Vitória",        has_modelogro: false, has_td: true  },
