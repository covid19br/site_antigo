...
const locale =
    [ 
        ...
        { prep: "em", uf: "AC", mun:"Rio_Branco",            verbose: "Rio Branco",            has_modelogro: false, has_td: true  },
        { prep: "em", uf: "AL", mun:"Maceio",                verbose: "Maceió",                has_modelogro: false, has_td: true  },
        { prep: "em", uf: "CE", mun:"Maracanau",             verbose: "Maracanaú",             has_modelogro: false, has_td: true  },
        { prep: "em", uf: "ES", mun:"Serra",                 verbose: "Serra",                 has_modelogro: false, has_td: true  },
        { prep: "em", uf: "MA", mun:"Imperatriz",            verbose: "Imperatriz",            has_modelogro: false, has_td: true  },
        { prep: "em", uf: "MS", mun:"Campo_Grande",          verbose: "Campo Grande",          has_modelogro: false, has_td: true  },
        { prep: "em", uf: "MT", mun:"Cuiaba",                verbose: "Cuiabá",                has_modelogro: false, has_td: true  },
        { prep: "em", uf: "PE", mun:"Jaboatao_dos_Guararapes",verbose: "Jaboatão dos Guararapes",has_modelogro:false,has_td: true  },
        { prep: "em", uf: "PE", mun:"Paulista",              verbose: "Paulista",              has_modelogro: false, has_td: true  },
        { prep: "em", uf: "PI", mun:"Teresina",              verbose: "Teresina",              has_modelogro: false, has_td: true  },
        { prep: "em", uf: "RJ", mun:"Nova_Iguacu",           verbose: "Nova Iguaçu",           has_modelogro: false, has_td: true  },
        { prep: "em", uf: "RJ", mun:"Sao_Goncalo",           verbose: "São Gonçalo",           has_modelogro: false, has_td: true  },
        { prep: "em", uf: "RJ", mun:"Belford_Roxo",          verbose: "Belford Roxo",          has_modelogro: false, has_td: true  },
        { prep: "em", uf: "RN", mun:"Natal",                 verbose: "Natal",                 has_modelogro: false, has_td: true  },
        { prep: "em", uf: "RO", mun:"Porto_Velho",           verbose: "Porto Velho",           has_modelogro: false, has_td: true  },
        { prep: "em", uf: "RR", mun:"Boa_Vista",             verbose: "Boa Vista",             has_modelogro: false, has_td: true  },
        { prep: "em", uf: "SE", mun:"Aracaju",               verbose: "Aracajú",               has_modelogro: false, has_td: true  },
        { prep: "em", uf: "TO", mun:"Palmas",                verbose: "Palmas",                has_modelogro: false, has_td: true  }
    ];
